...
<script>
import { fetchList, newMessage, deleteMessage, editMessage } from '@/api/message'
export default {
  name: 'Message',
  ...
  methods: {
    ...
    confirmEdit() {
      editMessage(this.editFrom).then(() => {
        this.editFrom = {}
        this.editDialog = !this.editDialog
        this.$message({
          message: '修改成功',
    ...
    confirmDelte() {
      ...
      deleteMessage({ id: this.deleteId })
      this.getList()
    }
  }
}
